...
rf<- randomForest(PRODUCTION_TOTAL_RMR ~  OPPORTUNITY_TYPE + FINANCE_TYPE + TENURE + KIT_PREMIUM_PACKAGE + PRODUCTION_COMMISSION_TYPE_CATEGORY + PRODUCTION_IS_SAME_DAY + PRODUCTION_IS_CHARITY + top_salesperson, data=train, importance = TRUE)
